...
app.post("/socketOn", (req, res) => {
  console.log("req.body.socketOn", req.body.socketOn);
  if (!req.body.socketOn) {
    // io.off('connection');
    // io.off('data');
    // io.off('data');
    io.removeAllListeners("connection", listener);
    // io.removeAllListeners();
  }
  res.send(req.body.socketOn);
});
